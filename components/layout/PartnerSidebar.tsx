...
import { LayoutDashboard, User, FileText, MessageSquare, LogOut } from 'lucide-react'
...
const navItems = [
  ...
  { href: '/parceiro/meu-perfil', label: 'Meu perfil', icon: User },
  { href: '/parceiro/posts',      label: 'Posts',      icon: FileText },
  { href: '/parceiro/leads',      label: 'Leads',      icon: MessageSquare },
]
  ...
  return (
    <aside className="w-64 min-h-screen bg-dark-950 border-r border-dark-800 flex flex-col">
      <div className="p-6 border-b border-dark-800">
        <Logo size="sm" />
        <div className="mt-1">
          <span className="text-xs text-gold-500 font-medium uppercase tracking-widest">Área Parceiro</span>
        </div>
      </div>
